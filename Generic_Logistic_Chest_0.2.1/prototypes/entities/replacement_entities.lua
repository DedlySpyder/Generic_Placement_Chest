...
data:extend({generic_logistic_chest_passive_provider, generic_logistic_chest_active_provider, generic_logistic_chest_storage, generic_logistic_chest_requester})